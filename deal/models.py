...
class Deals(models.Model):
    ...
    def filter_sold_data(self):
        ...
        if df is not None:
            logger.debug(
                f"Filtering the dataframe to return data for the last{self.computeDeal.period}")
    ...
    def percentage_average_market_data(self):
        ...
        p_value = average_price - \
            ((self.computeDeal.get_percentage_compare_average_price()/100) * average_price)
...
<<<<<<< HEAD
    ...
    def formatting(self):
        df = self.percentage_average_market_data()  
...
=======
>>>>>>> 6c4f769e840d704d2df933e6bb0583eddc2b9c01
